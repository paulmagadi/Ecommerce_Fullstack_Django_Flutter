...
class CartProvider with ChangeNotifier {
  ...
  Future<void> _saveCartToPrefs() async {
    ...
    List<String> cartItemsJson = _cartItems.values.map((item) => json.encode(item.toMap())).toList();
  ...
  Future<void> _loadCartFromPrefs() async {
    ...
    if (cartItemsJson != null) {
      ...
      for (String itemJson in cartItemsJson) {
        ...
        Product product = await _fetchProductById(itemMap['productId']);  // Fetch product details by ID
