...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('size', models.CharField(blank=True, max_length=255, null=True, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='WebBanner',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='products', to='store.category')),
                ('color', models.ManyToManyField(blank=True, related_name='products', to='store.color')),
                ('size', models.ManyToManyField(blank=True, related_name='products', to='store.size')),
            ],
        ),
        migrations.CreateModel(
            name='ProductImage',
